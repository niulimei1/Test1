...
public class BarChart1 {
	...
	public BarChart1() {
		...
		JFreeChart chart1 = ChartFactory.createBarChart3D("被隔离人数统计表", // 图表标题
				"日期", // 目录轴的显示标签
				"人数", // 数值轴的显示标签
				dataset, // 数据集
	...
	private static CategoryDataset getDataSet() {
		...
		dataset.addValue(7, "3.1", "3.1");// 数据1
		dataset.addValue(7, "3.2", "3.2");// 数据2
		dataset.addValue(6, "3.3", "3.3");// 数据3
		dataset.addValue(5, "3.4", "3.4");// 数据4
		dataset.addValue(4, "3.5", "3.5");// 数据1
		dataset.addValue(4, "3.6", "3.6");// 数据2
		...
		dataset.addValue(3, "3.12", "3.12");// 数据4
		dataset.addValue(3, "3.13", "3.13");// 数据3
		dataset.addValue(3, "3.14", "3.14");// 数据4
		return dataset;
	...
	public static void main(String args[]) {
		JFrame frame = new JFrame("被隔离人数统计表");
		frame.setLayout(new GridLayout(2, 2, 10, 10));
		frame.add(new BarChart1().getChartPanel()); // 添加柱形图
